...
def test_login_with_invalid_creds(page:  Page):
    ...
    login_user(page, os.getenv('INVALID_EMAIL'), os.getenv('INVALID_PASSWORD'))
...
def test_signup_with_invalid_creds(page: Page):
    open_home_page(page)
    sign_up(page, os.getenv('NAME'), os.getenv('INVALID_EMAIL'), os.getenv('INVALID_PASSWORD'))
...
def test_search_project_in_company(page: Page):
    ...
    login_user(page,os.getenv('EMAIL'), os.getenv('PASSWORD'))
